...
layout = [
            ...
            [sg.Input(key='_DATE_', default_text="default=now",size=(20,1)), sg.CalendarButton('Schedule Videos', close_when_date_chosen=True,  target='_DATE_', enable_events=True, location=(40,40), no_titlebar=False, )],
